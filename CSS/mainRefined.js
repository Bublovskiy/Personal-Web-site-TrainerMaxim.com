...
//MARK: DECLARATION OF ALL VERIABLES 
...
//MARK: INITIALIZATIONS OF ALL VERIABLES 
...
//getting elements of the form sendMessage which need to be validated
requiredElements = document.getElementsByClassName("needsToBeValidated");
//getting elements of the bottom fixed panel in mobile view mode
...
mainWindow.resize(function() {
  if (mainWindow.outerWidth() >= 768) {background5.css("height","70rem");}
  	...
  	//depending on clickSign state (true - boxes dropped down / false - boxes hidden) change height of the background5 
...
function clickForward() {
  ...
  var viewPortWidth = mainWindow.outerWidth();
